...
-- corresponding constants in lualog.fab

-- Must be an unused memory address
LOG_WRITE_HOOK_ADDR = 0xFF
-- I used 0xFF because older FCEUX versions seem to have a bug with
-- write hooks on non-zeropage addresses. Your NESFab project may
-- or may not use this one. Try 0x108 if in doubt.
